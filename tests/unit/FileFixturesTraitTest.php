...
final class FileFixturesTraitTest extends TestCase
{
    ...
    public function testRegisterAndGetFixturesPath(): void
    {
        ...
        self::assertSame(__DIR__ . '/Fixtures', self::getFixturePath());
        self::assertSame(__DIR__ . '/Fixtures/Subfolder', self::getFixturePath('SUBFOLDER'));
    }
    ...
    public function testGetFixtureFilename(): void
    {
        ...
        self::assertSame(__DIR__ . '/Fixtures/test_root_file', self::getFixtureFilename('TEST:test_root_file'));
    }
